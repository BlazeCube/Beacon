...
public class AsyncPacketOutEvent extends AsyncPacketEvent implements Cancellable{
    ...
    public PacketOut getPacket(){
        return (PacketOut)super.packet;
    }

    @Override
    public void setPacket(Packet packet){
        this.setPacket((PacketOut)packet);//PacketIn caused exception. perfect here
    }
    ...
    public AsyncPacketOutEvent(PacketOut packetOut){
        super();
        super.packet = packetOut;
    }
}
