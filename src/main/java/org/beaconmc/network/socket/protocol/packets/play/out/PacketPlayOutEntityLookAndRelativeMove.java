...
@NoArgsConstructor
@AllArgsConstructor
public class PacketPlayOutEntityLookAndRelativeMove extends PacketPlayOutEntity implements PacketOut{
    ...
    public PacketPlayOutEntityLookAndRelativeMove(int entityId, Location location, boolean onGround){
        super(entityId);
    ...
    public void write(PacketSerializer packetSerializer, int protocolVersion) {
        ...
        packetSerializer.writeByte((byte) MathUtils.toPacketInt(this.location.getX()));
        packetSerializer.writeByte((byte) MathUtils.toPacketInt(this.location.getY()));
        packetSerializer.writeByte((byte) MathUtils.toPacketInt(this.location.getZ()));
