 ...
 * @author Jan Delius
 */
 package org.beaconmc.network.socket.protocol.packets.status.out;
...
@NoArgsConstructor
@AllArgsConstructor
public class PacketStatusOutResponse extends PacketStatus implements PacketOut, AsyncPacket {
    ...
    public void write(PacketSerializer packetSerializer, int protocolVersion) {
        packetSerializer.writeString(this.serverPing.toJSON());
    }
}
