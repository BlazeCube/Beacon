...
@NoArgsConstructor
@AllArgsConstructor
public class PacketLoginOutDisconnect extends PacketLogin implements PacketOut, AsyncPacket {

    @Getter@Setter
    private ChatElement reason;

    @Override
    public void write(PacketSerializer packetSerializer, int protocolVersion) {
        packetSerializer.writeChat(this.reason);
    }
