...
@AllArgsConstructor
@NoArgsConstructor
public class PacketPlayInPlayerPositionAndLook extends PacketPlay implements PacketIn {
	...
	public void read(PacketSerializer packetSerializer, int protocolVersion) {
		this.location = new Location(null, packetSerializer.readDouble(), packetSerializer.readDouble(), packetSerializer.readDouble(), packetSerializer.readFloat(), packetSerializer.readFloat());
