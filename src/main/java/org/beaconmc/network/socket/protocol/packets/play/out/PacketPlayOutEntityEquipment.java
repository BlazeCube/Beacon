...
@NoArgsConstructor
@AllArgsConstructor
public class PacketPlayOutEntityEquipment extends PacketPlayOutEntity implements PacketOut{
    ...
    public void write(PacketSerializer packetSerializer, int protocolVersion) {
        ...
        packetSerializer.writeShort(this.slot);
        packetSerializer.writeItem(this.item);
    }
