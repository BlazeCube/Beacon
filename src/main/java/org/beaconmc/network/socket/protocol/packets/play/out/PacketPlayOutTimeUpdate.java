...
@NoArgsConstructor
@AllArgsConstructor
public class PacketPlayOutTimeUpdate extends PacketPlay implements PacketOut{
    ...
    public void write(PacketSerializer packetSerializer, int protocolVersion) {
        packetSerializer.writeLong(this.worldAge);
        packetSerializer.writeLong(this.dayTime);
    }
