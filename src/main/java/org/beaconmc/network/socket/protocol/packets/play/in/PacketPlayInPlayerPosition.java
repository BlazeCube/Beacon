...
@AllArgsConstructor
@NoArgsConstructor
public class PacketPlayInPlayerPosition extends PacketPlay implements PacketIn {
	...
	public void read(PacketSerializer packetSerializer, int protocolVersion) {
		this.location = new Location(packetSerializer.readDouble(), packetSerializer.readDouble(), packetSerializer.readDouble());
