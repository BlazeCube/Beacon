...
@NoArgsConstructor
@AllArgsConstructor
public class PacketPlayOutPluginMessage extends PacketPlay implements PacketOut{
    ...
    public void write(PacketSerializer packetSerializer, int protocolVersion) {
        packetSerializer.writeString(this.channel);
        packetSerializer.writeByteArray(this.data);
    }
