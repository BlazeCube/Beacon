...
@NoArgsConstructor
@AllArgsConstructor
public abstract class PacketPlayOutEntity extends PacketPlay implements PacketOut {

	@Getter@Setter
	private int entityId;
	@Getter@Setter
	private boolean sendToOwnClient = false;
	...
	public void write(PacketSerializer packetSerializer, int protocolVersion) {
		packetSerializer.writeVarInt(entityId);
	}
